...
public:
	...
	static CVector3 Normal(CVector3 vPolygon[])					
	...
	static CVector3 ClosestPointOnLine(CVector3 vA, CVector3 vB, CVector3 vPoint)
	{
	...
	static bool IntersectedPlane(CVector3 vPoly[], CVector3 vLine[], CVector3 &vNormal, float &originDistance)
	{
	...
	static bool InsidePolygon(CVector3 vIntersection, CVector3 Poly[], long verticeCount)
	{
	...
	static bool IntersectedPolygon(CVector3 vPoly[], CVector3 vLine[], int verticeCount)
	{
		CVector3 vNormal;
	...
	static int ClassifySphere(CVector3 &vCenter, 
	...
	static bool EdgeSphereCollision(CVector3 &vCenter, 
	...
	static bool SpherePolygonCollision(CVector3 vPolygon[], 
	...
	static CVector3 GetCollisionOffset(CVector3 &vNormal, float radius, float distance)
	{
